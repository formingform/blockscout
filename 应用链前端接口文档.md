...
### 验证人出块列表
- http://10.2.13.12:4000/api/v2/validators/blocks-produced?validator_hash=0x97ab3d4f7f5051f127b0e9f8d10772125d94d65b
```json
{
	"items": [{
...
### 验证人质押列表
- http://10.2.13.12:4000/api/v2/validators/delegator?validator_hash=0x97ab3d4f7f5051f127b0e9f8d10772125d94d65b
```json
{
	"items": [{
		"amount": "1000000000",
